...
\draw[nchoice] (\PairV{a}{qa}) to node[auto,above,sloped] {
    $(\tau,h_0),( y \le C_\alpha ) \land ( y \le W_\beta )$
} (aadec);
...
\draw[nchoice] (\PairV{a}{qa}) to node[auto,above,sloped] {
    $(\tau,h_1),( y \le C_\alpha ) \land ( W_\beta < y )$
} (abdec);
...
\draw[nchoice] (\PairV{a}{qa}) to node[auto,above,sloped] {
    $(\tau,h_2),( C_\alpha < y ) \land ( y \le W_\beta )$
} (acdec);
...
\draw[nchoice] (\PairV{a}{qa}) to node[auto,above,sloped] {
    $(\tau,h_3),( C_\alpha < y ) \land ( W_\beta < y )$
} (addec);
...
\draw[nchoice] (\PairV{b}{qb}) to node[auto,above,sloped] {
    $(\tau,h_0),( y \le C_\beta ) \land ( y \le W_\alpha )  $
} (badec);
...
\draw[nchoice] (\PairV{b}{qb}) to node[auto,above,sloped] {
    $(\tau,h_1),( y \le C_\beta )  \land ( W_\alpha < y )$
} (bbdec);
...
\draw[nchoice] (\PairV{b}{qb}) to node[auto,above,sloped] {
    $(\tau,h_2),( C_\beta < y ) \land ( y \le W_\alpha )$
} (bcdec);
...
\draw[nchoice] (\PairV{b}{qb}) to node[auto,above,sloped] {
    $(\tau,h_3),( C_\beta < y ) \land ( W_\alpha < y )$
} (bddec);
