...
% \vspace{-0.8em}
In this part, we define the problem of model-checking {PTAs} against TA-specifications.
...
if the infinite word $\lbfunc(\infpath)$ is Rabin- (or finitely-) accepted by $\dta$ w.r.t
$
