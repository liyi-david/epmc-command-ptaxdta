...
In this paper, we study the problem of model-checking linear \emph{dense-time} temporal properties over PTAs.
In particular, we consider linear dense-time properties that can be encoded by TAs with infinite acceptance criterion.
...
Our results substantially extend previous ones with both the dense-time feature and the nondeterminism in TAs. 
\end{abstract}
