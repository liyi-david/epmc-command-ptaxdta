...
\end{cases}
\end{align*}
for all $(\loc,\dtloc),(\loc',\dtloc')\in \locs_\otimes$, $(a,h) \in  \acts_\otimes$ and $Y \in \clocks_\otimes$.
\end{compactitem}
...
Since Rabin acceptance condition subsumes reachability, one obtains that the problem PTA-DTRA is EXPTIME-hard 
%(cf. Appendix~\ref{app:hardness} for details)
.
